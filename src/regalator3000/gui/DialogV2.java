...
public class DialogV2 extends JPanel implements ActionListener{
	...
	public void initcomponents(){
		...
		centerPanel.add(new JLabel("Made by some people I guess"));
		if (estado == 0){
	...
	public void actionPerformed(ActionEvent evt){
		...
		if (command == null){ //timer
	    	...
	    	if (command.equals("De acuerdo!") && estado == 0){
	    		estado=1;
	    		this.getTopLevelAncestor().setLocation(randomGen.nextInt(600)+200, randomGen.nextInt(250)+350);
	    		...
	    		this.initcomponents();
	    		this.revalidate();
	    		this.getTopLevelAncestor().setLocation(randomGen.nextInt(200)+400, randomGen.nextInt(150)+450);
	    	}
    ...
    public void generateDummyFrame(int window){
    	...
    	dummyFrame1.setLocation(randomGen.nextInt(800), randomGen.nextInt(600));
    	...
    	dummyFrame2.setLocation(randomGen.nextInt(800), randomGen.nextInt(600));
