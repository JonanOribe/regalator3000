...
public class Proposal_GUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jCheckBox1.setText("Vales de regalo");

        jCheckBox2.setText("Librería");

        jCheckBox3.setText("Electrodomesticos");

        jCheckBox4.setText("Viajes");

        jCheckBox5.setText("Joyería");

        jCheckBox6.setText("Moda");

        jCheckBox7.setText("Restaurantes");

        jCheckBox8.setText("Ocio");

        jCheckBox9.setText("Tecnología");
